        ...
        if (req.session.friendsInvited >= req.session.invitationAvailable) {
            ...
            newUser.save(function(err) {
                if (err) {
                    ...
                    newFriend.id = req.user._id;
                    // id parent
                    newFriend.emailParent = req.user.email;
                    // mail user
                    newFriend.emailFriend = newUser.email;
                    // mail friend
                    ...
                    newFriend.save(function(err) {
                        if (err) {
                            ...
                            lib.sendmailToPerson(newUser.name.first, newUser.email, '', newUser.resetPasswordToken, req.user.name.first, req.user.name.last, req.user.email, 'friend');
                            // send email to Parent
                            lib.sendmailToPerson(req.user.name.first, req.user.email, '', '', newUser.name.first, '', newUser.email, 'parent');
